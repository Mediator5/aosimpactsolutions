...
const footerLinks = {
  company: [
    ...
    { label: 'FAQs',           href: '/#faq' },
    { label: 'Contact Us',     href: 'mailto:info@aosimpactsolutions.com' },
...
export default function Footer() {
  ...
  return (
    <footer style={{ background: 'var(--color-surface)', borderTop: '1px solid var(--color-border)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto', padding: '4rem 1.5rem 2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px,1fr))', gap: '3rem', marginBottom: '3rem' }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', fontWeight: 300,
              color: 'var(--color-muted)', lineHeight: 1.8, marginBottom: '1.5rem' }}>
              Helping individuals and families remove inaccurate negative items and rebuild their financial future.
            </p>
          ...
          {/* Hours + Contact */}
          <div>
            <h4 style={colH}>Business Hours</h4>
            <div style={{ height: '1px', background: 'linear-gradient(90deg, var(--color-gold-dark), transparent)', marginBottom: '1.25rem' }} />
        ...
        <p style={{ marginTop: '1.5rem', fontFamily: 'var(--font-body)', fontSize: '0.68rem', fontWeight: 300,
          ...
          We cannot guarantee the removal of any specific item from your credit report.
          You have the right to dispute inaccurate information on your credit report yourself at no charge.
        </p>
      </div>
    </footer>
  )
