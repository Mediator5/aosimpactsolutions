  ...
  return (
    <section id="about" ref={sectionRef} style={{
      ...
      <div style={{ position: 'absolute', right: '-200px', top: '50%', transform: 'translateY(-50%)',
        width: '600px', height: '600px', borderRadius: '50%', border: '1px solid rgba(201,168,76,0.06)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', right: '-150px', top: '50%', transform: 'translateY(-50%)',
        width: '400px', height: '400px', borderRadius: '50%', border: '1px solid rgba(201,168,76,0.08)', pointerEvents: 'none' }} />
      ...
      <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px,1fr))', gap: '5rem', alignItems: 'center' }}>
          ...
          <div data-reveal style={{ opacity: 0, transform: 'translateX(-30px)',
            ...
            <div style={{ position: 'relative', borderRadius: 'var(--radius-lg)', overflow: 'hidden',
              ...
              <div style={{ position: 'absolute', inset: 0,
                background: 'linear-gradient(to bottom, transparent 50%, rgba(8,8,8,0.75) 100%)', pointerEvents: 'none' }} />
              <div style={{ position: 'absolute', bottom: '1.5rem', left: '1.5rem', right: '1.5rem' }}>
                <p style={{ fontFamily: 'var(--font-heading)', fontSize: '1.4rem', fontWeight: 400,
                  color: 'var(--color-white)', marginBottom: '0.15rem' }}>Aisha</p>
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.65rem', fontWeight: 600,
                  letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--color-gold)' }}>
            ...
            <div style={{ position: 'absolute', bottom: '-1.5rem', right: '-1.5rem',
              background: 'var(--color-black)', border: '1px solid rgba(201,168,76,0.25)',
              ...
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.7rem', fontWeight: 500,
          ...
          <div>
            ...
            <div data-reveal style={{ opacity: 0, transform: 'translateY(20px)', transition: 'opacity 0.7s ease, transform 0.7s ease' }}>
              <p style={body}>My name is <strong style={{ color: 'var(--color-gold-light)', fontWeight: 500 }}>Aisha</strong>, founder of AOS Impact Solutions.
                For over 15 years, I've worked as a Registered Nurse, dedicating my career to helping people improve their lives.
              ...
              <p style={{ ...body, fontFamily: 'var(--font-heading)', fontSize: '1.15rem', fontStyle: 'italic',
                color: 'var(--color-gold-light)', borderLeft: '2px solid var(--color-gold)',
              ...
              <p style={body}>At AOS Impact Solutions, my mission is to help individuals and families build stronger credit profiles so they can
                ...
                Helping people is what I've always done in healthcare — and now I bring that same level of care, attention to detail,
                and commitment to helping you restore and strengthen your credit.</p>
            </div>

            <div data-reveal style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', marginTop: '2rem',
              ...
              {['Registered Nurse, RN','Credit Repair Specialist','Financial Educator','15+ Years Experience'].map((tag) => (
                <span key={tag} style={{ padding: '0.4rem 1rem', border: '1px solid rgba(201,168,76,0.2)',
                  borderRadius: '100px', fontFamily: 'var(--font-body)', fontSize: '0.72rem', fontWeight: 500,
                  letterSpacing: '0.06em', color: 'var(--color-muted-light)', background: 'rgba(201,168,76,0.04)' }}>{tag}</span>
              ))}
            </div>
          </div>
        </div>
...
const body = { fontFamily: 'var(--font-body)', fontSize: '0.92rem', fontWeight: 300,
